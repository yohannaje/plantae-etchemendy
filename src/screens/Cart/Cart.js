  ...
  return (
    <div className="cartContainer">
      {cartItems.length === 0 ? (
        ...
        <EmptyPageComponent
        imgUrl="https://image.freepik.com/free-vector/add-cart-concept-illustration_114360-2521.jpg"
        ...
        <div className="cartContent">
          ...
          <div className="cartTotal">
            <h2>Total</h2>
            <p><b>Cantidad de productos:</b> {itemsQty}</p>
            <p><b>Costo Final:</b> ${itemsPrice}</p>
            <p><b>Envio:</b> Gratis</p>
          </div>
          </section>
          <section className="purchase">
          <div className="userInfo">
          <h2>Mis Datos</h2>
          <Form cartItems={cartItems} itemsPrice={itemsPrice} clear={clear}/>
          </div> 
          </section>
